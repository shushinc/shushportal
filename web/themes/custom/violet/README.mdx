...
violet theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of violet theme and run the following commands:
`nvm use`
...
`drush en violet -y`
`drush config-set system.theme default violet -y`
