 ...
 */
class ManageApiAttributes extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $query = $this->database->select('api_attributes_page_data', 'at')
    ...
    foreach ($results as $row) {
      ...
      $rows[] = [
        ...
        'url' => Link::createFromRoute('Delete', 'zcs_api_attributes.delete_api_attribute', ['id' => $row->id]),
      ];
    }
