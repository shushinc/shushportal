 ...
 */
class ManageDiscountPricing extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $query = $this->database->select('discount_pricing_page_data', 'dppd')
    ->fields('dppd', ['id', 'submit_by','client_name', 'approver1_uid', 'approver2_uid', 'approver1_status', 'approver2_status', 'attribute_status', 'created'])
    ...
    foreach ($results as $row) {
      ...
      $rows[] = [
        ...
        'url' => Link::createFromRoute('Delete', 'zcs_api_attributes.pricing_discount_delete', ['id' => $row->id]),
      ];
    }
