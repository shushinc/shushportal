SELECT SUM(node__field_average_api_latency_in_mil.field_average_api_latency_in_mil_value)/ COUNT(node__field_average_api_latency_in_mil.entity_id)  AS total from node
